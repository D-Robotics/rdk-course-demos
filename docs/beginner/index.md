...
Select a course title to read its handbook. The supporting materials column links to code or slides. Unpublished handbooks are listed separately below each board table.

## Common foundation

These lessons apply across the RDK platform family.

| Course handbook | Supporting materials |
| --- | --- |
...
| Course handbook | Supporting materials |
| --- | --- |
| [Flash a system image](x5/flash-system.md) | — |
